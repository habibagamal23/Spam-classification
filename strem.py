...
st.write("## Model Description: Naive Bayes Model trained on SMS data")
...
st.markdown("<h2 style='color: red;'>Model Accuracy: <b>{:.2f}%</b></h2>".format(acc*100), unsafe_allow_html=True)
